      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='flex items-center justify-between h-14 sm:h-16'>
          ...
          <div className='flex items-center'>
            ...
            >
              <div className='w-7 h-7 sm:w-8 sm:h-8 md:w-10 md:h-10 bg-gradient-to-br from-amber-500 via-yellow-400 to-orange-400 rounded-lg sm:rounded-xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300 group-hover:rotate-3'>
                <span className='text-white text-xs sm:text-sm md:text-lg font-bold'>
                  💰
                </span>
              </div>
              <span className='text-sm sm:text-base md:text-lg lg:text-xl font-bold bg-gradient-to-r from-amber-600 via-yellow-500 to-orange-400 bg-clip-text text-transparent'>
          ...
          <div className='hidden md:flex items-center space-x-1'>
            <Link
              href='/'
              className='relative text-gray-700 dark:text-gray-300 hover:text-amber-600 dark:hover:text-amber-400 px-3 lg:px-4 py-2 rounded-xl text-sm font-medium transition-all duration-200 hover:bg-amber-50/50 dark:hover:bg-amber-900/20 group'
            >
              <span className='relative z-10'>Home</span>
              <div className='absolute inset-0 bg-gradient-to-r from-amber-500/10 to-yellow-400/10 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-200'></div>
            </Link>
          ...
          <div className='flex items-center space-x-1 sm:space-x-2'>
            ...
            <div className='hidden sm:block'>
              <SignedOut>
                <SignInButton>
                  <button className='relative overflow-hidden bg-gradient-to-r from-amber-500 via-yellow-400 to-orange-400 hover:from-amber-600 hover:via-yellow-500 hover:to-orange-500 text-white px-3 sm:px-4 py-2 rounded-lg sm:rounded-xl text-xs sm:text-sm font-semibold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 active:scale-95'>
              ...
              <SignedIn>
                <div className='p-0.5 sm:p-1 rounded-lg sm:rounded-xl bg-gradient-to-r from-amber-100/50 to-yellow-100/50 dark:from-amber-900/20 dark:to-yellow-900/20 backdrop-blur-sm border border-amber-200/30 dark:border-amber-700/30'>
                  <UserButton
                    appearance={{
                      elements: {
                        avatarBox:
        ...
        >
          <div className='px-2 pt-2 pb-3 space-y-1 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl border border-gray-200/50 dark:border-gray-600/50 mt-2 shadow-lg'>
            ...
            <div className='pt-3 border-t border-gray-200/50 dark:border-gray-600/50'>
              ...
              <SignedIn>
                <div className='flex items-center justify-center p-3 rounded-xl bg-gradient-to-r from-amber-100/50 to-yellow-100/50 dark:from-amber-900/20 dark:to-yellow-900/20 backdrop-blur-sm border border-amber-200/30 dark:border-amber-700/30'>
                  <UserButton
                    appearance={{
                      elements: {
                        avatarBox:
